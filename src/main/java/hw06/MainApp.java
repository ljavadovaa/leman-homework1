...
public class MainApp {
    public static void main(String[] args) {
        ...
        schedule[0][0] = Human.DayOfWeek.Sunday.name();
        schedule[0][1] = "do home work";
        schedule[1][0] = Human.DayOfWeek.Monday.name();
        schedule[1][1] = "go to courses; watch a film.";
        schedule[2][0] = Human.DayOfWeek.Tuesday.name();
        schedule[2][1] = "go to the cinema";
        schedule[3][0] = Human.DayOfWeek.Wednesday.name();
        schedule[3][1] = "meet with friends";
        schedule[4][0] = Human.DayOfWeek.Thusday.name();
        schedule[4][1] = "visit your parents";
        schedule[5][0] = Human.DayOfWeek.Friday.name();
